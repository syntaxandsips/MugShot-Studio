...
export function AI_Prompt() {
  ...
  return (
    <div className="w-full max-w-2xl py-4 mx-auto">
      <div className="bg-[#02312d] rounded-2xl p-1.5">
          ...
          <div className="relative flex flex-col">
            ...
            >
              <Textarea
                ...
                className={cn(
                  "w-full rounded-xl rounded-b-none px-4 py-3 bg-[#02312d] border-none text-white placeholder:text-white/70 resize-none focus-visible:ring-0 focus-visible:ring-offset-0",
                  "min-h-[72px]"
                )}
                ref={textareaRef}
            ...
            <div className="h-14 bg-[#02312d] rounded-b-xl flex items-center">
